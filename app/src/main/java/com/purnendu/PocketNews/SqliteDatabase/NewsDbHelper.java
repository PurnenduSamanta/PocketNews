...
import com.purnendu.PocketNews.MainActivity;
import com.purnendu.PocketNews.NewsModel;
...
public class NewsDbHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<NewsModel> getAllNews(String tableName) {
        ArrayList<NewsModel> array_list = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
        ...
        if (res.moveToFirst())
        {
            do {
               ...
               array_list.add(new NewsModel(id,title,desc,posterUrl,newsUrl,date));
