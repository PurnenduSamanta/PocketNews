...
public class FragmentSports extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (context != null) {
            ...
            if (str != null) {
                String url = "https://newsapi.org/v2/top-headlines?country="+str+"&category=sports&apiKey=aba3006a25584cfd8fbb81b1c0c4ba5e";
                ...
                String url = "https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=aba3006a25584cfd8fbb81b1c0c4ba5e";
                View view = inflater.inflate(R.layout.fragment, container, false);
                recycler1 = view.findViewById(R.id.recycler1);
                AppData appData = new AppData();
                appData.fetch(url, recycler1, context);
