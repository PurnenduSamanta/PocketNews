...
import com.purnendu.PocketNews.RoomDb.TrendingNewsTableModel;
...
public class FragmentTrending extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //Setting Up ViewModel And RecyclerView Adapter
        ...
        viewModel = new ViewModelProvider(this, new FragmentViewModelFactory(repository, countryCode, NewsCategories.GENERAL.getCategoryName(), API_KEYS.fourthKey)).get(FragmentViewModel.class);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //Add observer
        viewModel.getTrendingNewsData().observe(getViewLifecycleOwner(), trendingNewsTableModels -> {
            ...
            for (TrendingNewsTableModel i : trendingNewsTableModels)
