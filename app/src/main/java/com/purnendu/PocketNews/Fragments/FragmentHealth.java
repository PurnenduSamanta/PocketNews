...
import com.purnendu.PocketNews.RoomDb.HealthNewsTableModel;
...
public class FragmentHealth extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this, new FragmentViewModelFactory(repository, countryCode, NewsCategories.HEALTH.getCategoryName(), API_KEYS.fourthKey)).get(FragmentViewModel.class);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.getHealthNewsData().observe(getViewLifecycleOwner(), healthNewsTableModels -> {

            boolean connectionStatus = Utility.Companion.checkConnection(context);
            if (healthNewsTableModels.size() == 0) {
            ...
            for (HealthNewsTableModel i : healthNewsTableModels)
