...
import com.purnendu.PocketNews.RoomDb.SportsNewsTableModel;
...
public class FragmentSports extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this, new FragmentViewModelFactory(repository, countryCode, NewsCategories.SPORTS.getCategoryName(), API_KEYS.fifthKey)).get(FragmentViewModel.class);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.getSportsNewsData().observe(getViewLifecycleOwner(), sportsNewsTableModels -> {

            boolean connectionStatus = Utility.Companion.checkConnection(context);
            if (sportsNewsTableModels.size() == 0) {
            ...
            for (SportsNewsTableModel i : sportsNewsTableModels)
