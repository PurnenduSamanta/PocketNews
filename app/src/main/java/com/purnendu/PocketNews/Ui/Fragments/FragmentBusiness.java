...
import com.purnendu.PocketNews.RoomDb.BusinessNewsTableModel;
...
public class FragmentBusiness extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this, new FragmentViewModelFactory(repository, countryCode, NewsCategories.BUSINESS.getCategoryName(), API_KEYS.secondKey)).get(FragmentViewModel.class);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.getBusinessNewsData().observe(getViewLifecycleOwner(), businessNewsTableModels -> {

            boolean connectionStatus = Utility.Companion.checkConnection(context);
            if (businessNewsTableModels.size() == 0) {
            ...
            for (BusinessNewsTableModel i : businessNewsTableModels)
